...
@section('title', 'Modifier une matière - ESIC')
...
<div class="actualite-container">
    <div class="actualite-header">
        <h2 class="actualite-title">Modifier la matière</h2>
    </div>
    ...
    <form action="{{ route('matieres.update', $matiere->id) }}" method="POST" class="actualite-form">
        @csrf
        @method('PUT')
